...
public class HotelRoomController extends BaseController {
    ...
    @SuppressWarnings( "rawtypes" )
    public ResponseDTO roomCategoryCU(@Validated @ModelAttribute RoomCategoryParameter.SaveOrUpdate roomCategory, BindingResult bindingResult, HttpSession session) {
