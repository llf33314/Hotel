...
/**
 * <p>
 * 房型关联 1 - n 客房信息 房型的客房数量 对应 客房数 Mapper 接口
 * </p>
 *
 * @author
 * @since 2017-10-09
...
public interface TRoomDAO extends BaseMapper<TRoom> {
	 ...
	 * @return
	 */
	List<RoomVo> queryRoomList(@Param("hotelId") Integer hotelId, @Param("categoryId") Integer categoryId,
	...
	List<RoomVo> queryRoomListAll(@Param("hotelId") Integer hotelId, @Param("categoryId") Integer categoryId,
			@Param("roomNumber") String roomNumber, @Param("roomStatus") Integer roomStatus);
	...
	/**
	 * 有效的客房 如果，返回的结果 >1 则存在某一客房在这时间某段内已经被入住
	 *
	 * @param ids
	 *            List<Integer>
	 * @return
