...
public class HotelWsWxShopInfoExtend {
     ...
     * 多粉内部ID
     */
    @ApiModelProperty("多粉内部ID")
    private String  sid;
    /**
     * 微信的门店ID
     */
    @ApiModelProperty("微信的门店ID")
     ...
     * 分店名
     */
    @ApiModelProperty("分店名")
    private String  branchName;
    /**
     * 门店类型主类型
     */
    @ApiModelProperty("门店类型主类型")
     ...
     */
    @ApiModelProperty("电话(固定电话需加区号；区号、分机号均用“-”连接)")
    private String  telephone;
    /**
     * 人均价格(大于零的整数，须如实填写，默认单位为人民币)
     */
    @ApiModelProperty("人均价格(大于零的整数，须如实填写，默认单位为人民币)")
     ...
     * 推荐品
     */
    @ApiModelProperty("推荐品")
    private String  recommend;
    /**
     * 门店所在的省份
     */
    @ApiModelProperty("门店所在的省份")
     ...
     * 坐标类型(1 为火星坐标（目前只能选1）)
     */
    @ApiModelProperty("坐标类型(1 为火星坐标（目前只能选1）)")
     ...
     */
    @ApiModelProperty("0：表示还没将门店信息发送到公众号审核，可修改全部内容；1：表示已发送给微信公众号审核  2 已审核通过 3审核通过后重新审核服务信息 4 送审被失败")
