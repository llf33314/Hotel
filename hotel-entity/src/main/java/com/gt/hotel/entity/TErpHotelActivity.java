 ...
 * @since 2017-08-14
 */
@ApiModel(value = "TErpHotelActivity")
@Data
...
public class TErpHotelActivity extends Model<TErpHotelActivity> {
     ...
     * 类型（0=秒杀）
     */
    public static final Integer SPIKE = 0;
    /**
     * 类型（1=团购）
     */
     ...
     */
	@ApiModelProperty(value = "类型（0=秒杀, 1=团购, 2=特价房, 3=时租房）")
	private Integer type;
    /**
     * 是否开启房间限购
     */
	@ApiModelProperty(value = "是否开启房间限购")
	@TableField("is_room_limit")
	private Integer isRoomLimit;
    /**
     * 房间限购数（间/人）
     */
	@ApiModelProperty(value = "房间限购数（间/人）")
	@TableField("room_limit")
	private Integer roomLimit;
    /**
     * 是否关联会员卡
     */
	@ApiModelProperty(value = "是否关联会员卡")
	@TableField("is_vipcard")
	private Integer isVipcard;
    /**
     * 是否关联卡券
     */
	@ApiModelProperty(value = "是否关联卡券")
     ...
     * 房间剩余数
     */
	@ApiModelProperty(value = "房间剩余数")
	@TableField("is_room_count")
	private Integer isRoomCount;
    /**
     * 当房剩余 room_count  间时显
     */
	@ApiModelProperty(value = "当房剩余 room_count  间时显")
     ...
     * 团购最低间数
     */
	@ApiModelProperty(value = "团购最低间数")
	private Integer grouplowest;
    /**
     * 当达不到最低间数提示
     */
	@ApiModelProperty(value = "当达不到最低间数提示")
	private String grouplowesttip;
    /**
     * 时租房使用时间
     */
	@ApiModelProperty(value = "时租房使用时间")
	@TableField("limit_hour")
	private Integer limitHour;
    /**
     * 时租房可预订起始时间
     */
	@ApiModelProperty(value = "时租房可预订起始时间")
	@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	private Date whenrentstime;
    /**
     * 时租房可预订结束时间
     */
	@ApiModelProperty(value = "时租房可预订结束时间")
	@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
