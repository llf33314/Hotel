...
public class BusUser extends Model< BusUser > {
	...
	return "BusUser{" + "id=" + id + ", name=" + name + ", email=" + email + ", password=" + password + ", phone=" + phone + ", gender=" + gender + ", registerIp=" + registerIp
	    + ", recentIp=" + recentIp + ", ctime=" + ctime + ", mtime=" + mtime + ", status=" + status + ", fansCurrency=" + fansCurrency + ", flow=" + flow + ", cityId=" + cityId
	    + ", level=" + level + ", startTime=" + startTime + ", endTime=" + endTime + ", years=" + years + ", statTime=" + statTime + ", industryid=" + industryid + ", pid="
	    + pid + ", smsCount=" + smsCount + ", istechnique=" + istechnique + ", advert=" + advert + ", busmoneyLevel=" + busmoneyLevel + ", regionids=" + regionids
	    + ", isagent=" + isagent + ", agentid=" + agentid + ", realname=" + realname + ", loginSource=" + loginSource + ", isBinding=" + isBinding + ", unbundlingTime="
	    + unbundlingTime + ", fixedPhone=" + fixedPhone + ", customerId=" + customerId + ", merchantName=" + merchantName + ", addSource=" + addSource + ", wzAuth=" + wzAuth
	    + "}";
    }
}
