...
public class HotelWsWxShopInfoExtend {
	...
	public String toString() {
		return "HotelWsWxShopInfoExtend [id=" + id + ", sid=" + sid + ", poiid=" + poiid + ", busId=" + busId
				+ ", businessName=" + businessName + ", branchName=" + branchName + ", categories=" + categories
				+ ", twoCategories=" + twoCategories + ", threeCategories=" + threeCategories + ", telephone="
				+ telephone + ", avgPrice=" + avgPrice + ", startTime=" + startTime + ", endTime=" + endTime
				+ ", special=" + special + ", introduction=" + introduction + ", recommend=" + recommend + ", province="
				+ province + ", city=" + city + ", district=" + district + ", address=" + address + ", offsetType="
				+ offsetType + ", longitude=" + longitude + ", latitude=" + latitude + ", status=" + status
				+ ", detail=" + detail + ", mainShop=" + mainShop + ", imageUrl=" + imageUrl + ", createTime="
				+ createTime + ", availableState=" + availableState + ", updateStatus=" + updateStatus + ", adder="
				+ adder + "]";
	}
