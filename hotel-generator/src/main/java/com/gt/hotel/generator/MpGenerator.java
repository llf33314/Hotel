...
public class MpGenerator {
	...
	// 需要生成的表
	public static final String[] generatorTableName = new String[] { "t_hotel_setting", "t_infrastructure",
			"t_activity", "t_activity_room", "t_authorization", "t_order", "t_order_coupons", "t_order_food",
			"t_order_food_detail", "t_order_room", "t_order_room_customer", "sys_operation_log", "t_activity_detail" };
	// 作者
